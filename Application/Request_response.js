...
function signUp(firstName, lastName, gender, email, birthDate, login, password) {
...
function getUserShortInfo(userId,clientId, token) {
    var request = new XMLHttpRequest()
    var params = 'http://127.0.1.1:6504/v1/mafclub/api/account/getUserShortInfo?userId='+userId+'u85&clientId='+clientId
    request.open('GET',params )
    request.setRequestHeader('token', token)
    request.send()
    request.onreadystatechange = function() {
...
function userUpdateInfo(token,userId,firstName, lastName, avatar, nickname) {
    var request = new XMLHttpRequest()
...
function changePassword(token, userId, password, newPassword) {
    var request = new XMLHttpRequest()
...
//////////////////////////////////////////////////////////////////////////////
function groupCreate(token,groupName,userId,access) {
    var request = new XMLHttpRequest()
...
function groupDelete(userId,token) {
    var request = new XMLHttpRequest()
...
function getGroupInfo(userId,groupId,token) {
    var request = new XMLHttpRequest()
...
function getGroupShortInfo(userId,groupId,token) {
    var request = new XMLHttpRequest()
    var params = 'http://127.0.1.1:6504/v1/mafclub/api/account/getGroupInfo?userId='+userId+'&groupId='+groupId
...
function groupUpdateInfo(groupId,userId,name,avatar) {
    var request = new XMLHttpRequest()
...
function groupRemoveUser(groupId,userId,clientId) {
    var request = new XMLHttpRequest()
